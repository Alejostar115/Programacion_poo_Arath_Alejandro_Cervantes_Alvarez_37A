...
// programa calcula el valor futuro de una inversión con aportaciones mensuales constantes y un interés compuesto, utilizando dos métodos diferentes para validar el resultado
